			...
			<div class="contenido">
				...
				<form action="save3.php" method="POST">
					...
					<input type="hidden" name="email" id="email" value="<?php echo $email; ?>">
						<legend>4.- DATOS LABORALES</legend>
						<div class="row">
							<div class="columns">
								<label>Trabaja: <small>requerido</small></label>
						...
						<div id="nowork">
							<div class="row">
								<div class="columns">
									<label>Ejerces la profesión: <small>requerido</small></label>
							...
							<div class="row">
								<table class="tabla">
									<tr>
										<td colspan="2"><label>Empleos Actuales:</label></td>
									</tr>
									<tr>
										<td colspan="2">
											<table>
					    ...
					    <div class="row">
							<div class="columns3">
								<label>¿Que tanto influyó tu preparación de posgrado en el empleo actual?: <small>requerido</small></label>
						...
						<div class="row">
							<table class="tabla">
								<tr>
									<td colspan="2">
										<label>¿En cuál de los siguientes aspectos considera que impactó el posgrado que cursó? (Enumere a partir de uno en orden de prioridad):</label>
									</td>
								</tr>
								<tr>
									<td colspan="2">
										<table>
											...
											<tr>
												...
												<td><input type="radio" name="aspecto_1" id="aspecto_1" value="1" required></td>
												<td><input type="radio" name="aspecto_1" id="aspecto_1" value="2"></td>
												<td><input type="radio" name="aspecto_1" id="aspecto_1" value="3"></td>
												<td><input type="radio" name="aspecto_1" id="aspecto_1" value="4"></td>
												<td><input type="radio" name="aspecto_1" id="aspecto_1" value="5"></td>
											</tr>
											<tr>
												<!--<td align="right"><input type="text" class="input_mini" placeholder="Numero"></td>-->
												<td colspan="6" align="left"><label for="">Posibilidad de incursionar en campos científicos</label></td>
												<td><input type="radio" name="aspecto_2" id="aspecto_2" value="1" required></td>
												<td><input type="radio" name="aspecto_2" id="aspecto_2" value="2"></td>
												<td><input type="radio" name="aspecto_2" id="aspecto_2" value="3"></td>
												<td><input type="radio" name="aspecto_2" id="aspecto_2" value="4"></td>
												<td><input type="radio" name="aspecto_2" id="aspecto_2" value="5"></td>
											</tr>
											<tr>
												<!--<td align="right"><input type="text" class="input_mini" placeholder="Numero"></td>-->
												<td colspan="6" align="left"><label for="">Apertura de oportunidades</label></td>
												<td><input type="radio" name="aspecto_3" id="aspecto_3" value="1" required></td>
												<td><input type="radio" name="aspecto_3" id="aspecto_3" value="2"></td>
												<td><input type="radio" name="aspecto_3" id="aspecto_3" value="3"></td>
												<td><input type="radio" name="aspecto_3" id="aspecto_3" value="4"></td>
												<td><input type="radio" name="aspecto_3" id="aspecto_3" value="5"></td>
											</tr>
											<tr>
												<!--<td align="right"><input type="text" class="input_mini" placeholder="Numero"></td>-->
												<td colspan="6" align="left"><label for="">Una mejor situación laboral</label></td>
												<td><input type="radio" name="aspecto_4" id="aspecto_4" value="1" required></td>
												<td><input type="radio" name="aspecto_4" id="aspecto_4" value="2"></td>
												<td><input type="radio" name="aspecto_4" id="aspecto_4" value="3"></td>
												<td><input type="radio" name="aspecto_4" id="aspecto_4" value="4"></td>
												<td><input type="radio" name="aspecto_4" id="aspecto_4" value="5"></td>
											</tr>
											<tr>
												<!--<td align="right"><input type="text" class="input_mini" placeholder="Numero"></td>-->
												<td align="left" colspan="6"><label for="">Otro, Especifique:</label></td>
												<td><input type="radio" name="aspecto_5" id="aspecto_5" value="1" required></td>
												<td><input type="radio" name="aspecto_5" id="aspecto_5" value="2"></td>
												<td><input type="radio" name="aspecto_5" id="aspecto_5" value="3"></td>
												<td><input type="radio" name="aspecto_5" id="aspecto_5" value="4"></td>
												<td><input type="radio" name="aspecto_5" id="aspecto_5" value="5"></td>
