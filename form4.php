		...
		<section class="main">
			...
			<div class="contenido">
				...
				<form action="save4.php" method="POST">
					<fieldset>
						<legend>5.- EDUCACIÓN CONTINUA</legend>
						<div class="row">
						<input type="hidden" name="email" id="email" value="<?php echo $email; ?>">
							<table class="tabla">
								<tr>
									<td colspan="2">
										<label>Si después de sus estudios de posgrado ha publicado, conteste la siguiente pregunta:</label>
									</td>
								</tr>
								<tr>
									<td colspan="2">
						...
						<div class="row">
							<table class="tabla">
								<tr>
									<td colspan="2"><label>Si después de sus estudios de posgrado ha realizado otros estudios (posgrados, diplomados, cursos o talleres), asistido o participado en eventos académicos (Congresos, conferencias, seminarios, etc.) conteste la siguiente pregunta:</label></td>
								</tr>
								<tr>
						...
						<div class="row">
							<table class="tabla">
								<tr>
									<td colspan="2"><label>Si pertenece a alguna organización profesional, proporcione la siguiente información:</label></td>
								</tr>
								<tr>
									<td colspan="2">
										<table>
					    ...
					    <div class="row">
					    	<table class="tabla">
					    		<tr><td colspan="2"><label>Si desea recibir información sobre las actividades que se realizan en esta Facultad marque con una “X” el tema de su interés:</label></td>
					    		</tr>
					    		<tr>
					    			<td colspan="2">
					    				<table>
					    ...
					    <div class="row">
					    	<div class="columns2">
								<label>¿Desea hacer algún comentario adicional?: <small>requerido</small></label>
