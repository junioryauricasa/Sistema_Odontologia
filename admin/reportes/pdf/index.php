...
$content = " 
	...
	<table border='0'>
			...
			<tr>
				<td rowspan='2'></td>
				<th align='center' style='background-color: #76923c;border: 1px solid #ccc;color:#FFFFFF;'>Hombres</th>
				<th align='center' style='background-color: #76923c;border: 1px solid #ccc;color:#FFFFFF;'>Mujeres</th>
				<td rowspan='2'></td>
			</tr>";
    $h=0;
    $m=0;
...
$content.=" <tr>
				<td align='center' style='background-color: #FFFFFF;color: #000000;border: 1px solid #ccc;padding: auto;'>". $h ."</td>	
				<td align='center' style='background-color: #FFFFFF;color: #000000;border: 1px solid #ccc;padding: auto;'>". $m ."</td>	
			</tr>
			<tr>
				<td colspan='4' height='50'></td>
			</tr>
			<tr>
				<td colspan='4' align='center'>Universidad Autónoma de Baja California</td>
			</tr>
			<tr>
				<td colspan='4' align='center'>Facultad de Odontología Campus Mexicali</td>
			</tr>
			<tr>
